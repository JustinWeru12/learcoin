             ...
             ListView(
              ...
              textAlign: TextAlign.left,
                ...
                Container(
                   ...
                   height:dheight*4/40,
                   child: buildForm2Field("Full Name",TextInputType.name),),
                 //
                 Container(
                   margin: EdgeInsets.only(left:dwidth * 1/10,right:dwidth*1/10),
                   height:dheight*4/40,
                   child: buildForm2Field("Phone Number",TextInputType.phone),),
                   Container(
                   margin: EdgeInsets.only(left:dwidth * 1/10,right:dwidth*1/10),
                   height:dheight*4/40,
                   child: buildForm2Field("Date of Birth",TextInputType.datetime),),
                   Container(
                   margin: EdgeInsets.only(left:dwidth * 1/10,right:dwidth*1/10),
                   height:dheight*4/40,
                   child: buildForm2Field("Email",TextInputType.emailAddress),),
                   Container(
                   margin: EdgeInsets.only(left:dwidth * 1/10,right:dwidth*1/10),
                   height:dheight*4/40,
                   child: buildForm2Field("Address",TextInputType.streetAddress),),
                  new Row(
                    // mainAxisAlignment: MainAxisAlignment.spaceBetween,
        children: <Widget>[
          new Flexible(
            child: Container(
              margin: EdgeInsets.only(left:dwidth * 1/10,right:2),
              child: buildForm2Field("City",TextInputType.name)),
          ),
          new Flexible(
            child: Container(
              margin: EdgeInsets.only(left:2,right:dwidth * 1/10),
              child: buildForm2Field("Zip code",TextInputType.name)),
          ),
        ],
      ),
                 Center(
