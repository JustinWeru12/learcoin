...
class ContractView extends StatelessWidget {
  ...
  const ContractView({Key key, this.contractname, this.startdate, this.paydate}) : super(key: key);
  // ContractView({
  //   Key key,
  // }) : super(key: key);
  @override
          ...
          Transform.translate(
            ...
            child: Container(
              ...
              textAlign: TextAlign.left,
                                     ...
                                     Padding(
               padding: const EdgeInsets.only(left:4.0,right: 4.0,bottom: 2.0,top: 4.0),
               child: Text.rich(
                    TextSpan(
                      style: TextStyle(
                        fontFamily: 'Serenity',
