  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            offset: Offset(38.0, 167.0),
            child: Container(
              width: 300.0,
              height: 41.0,
              child: buildEmailFormField("Name"),
              decoration: BoxDecoration(
          ...
          Transform.translate(
            ...
            child: Container(
              child: buildEmailFormField("Address"),
              width: 300.0,
              height: 41.0,
              decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(10.0),
          ...
          Transform.translate(
            ...
            child: Container(
              child: buildEmailFormField("Email"),
              width: 300.0,
              height: 41.0,
              decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(10.0),
          ...
          Transform.translate(
            ...
            child: Container(
              width: 300.0,
              height: 41.0,
              child: buildEmailFormField("Line 2"),
              decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(10.0),
                color: const Color(0xff545f66),
              ),
          ...
          Transform.translate(
            offset: Offset(38.0, 271.0),
            child: Container(
              child: buildEmailFormField("Country"),
              width: 143.0,
              height: 41.0,
              decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(10.0),
          ...
          Transform.translate(
            offset: Offset(196.0, 271.0),
            child: Container(
              child: buildEmailFormField("Date of Birth"),
              width: 143.0,
              height: 41.0,
              decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(10.0),
          ...
          Transform.translate(
            offset: Offset(196.0, 468.0),
            child: Container(
              width: 143.0,
              height: 41.0,
              child: buildEmailFormField("Zip Code"),
                            decoration: BoxDecoration(
                              borderRadius: BorderRadius.circular(10.0),
                              color: const Color(0xff545f66),
                            ),
                     ...
                     TextFormField buildEmailFormField(name) {
    return TextFormField(
      ...
      decoration: InputDecoration(
        fillColor: const Color(0xff545f66), filled: true,
        enabledBorder: OutlineInputBorder(
          borderSide: BorderSide(color: const Color(0xff545f66)),
